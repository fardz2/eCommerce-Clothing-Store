...
class HatItemsView extends GetView<HomePageController> {
  const HatItemsView({Key? key}) : super(key: key);
  @override
    ...
    return Obx(() => SingleChildScrollView(
          ...
          child: Container(
            ...
            child: StaggeredGrid.count(
              ...
              mainAxisSpacing: 20,
              crossAxisSpacing: 20,
              children: controller.hat().map((item) {
                int index = controller
                    .hat()
                    .indexWhere((items) => items.product_id == item.product_id);
